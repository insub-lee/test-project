...
const TopbarWrapper = styled.div`
  ...
  .devGuideUserDropdown {
    .ant-popover-inner {
      .ant-popover-inner-content {
        .devGuideUserDropdownContent {
          padding: 7px 0;
          display: flex;
          ...
          min-width: 160px;
          flex-shrink: 0;
          .devGuideBorderRadius(5px);
          ${borderRadius('5px')};
          ${boxShadow('0 2px 10px rgba(0,0,0,0.2)')};
          ${transition()};

          .devGuideDropdownLink {
            font-size: 13px;
