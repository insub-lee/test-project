                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colSpan="7" style={{ width: '100vw' }}>
                      <TextArea value="조치 상세 내용" readOnly autosize={{ minRows: 1, maxRow: 8 }} id="" />
                    </td>
                  </tr>
                  <tr>
                    <th>remark</th>
                    <td colSpan="7" style={{ width: '100vw' }}>
                      <TextArea value="비고" readOnly autosize={{ minRows: 1, maxRow: 8 }} id="" />
                    </td>
                  </tr>
                  <br />
                  <br />
