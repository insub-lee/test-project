...
class PMSheet extends PureComponent {
  ...
  onSelectionChanged = params => {
    ...
    // testArr = selectedRows;
    this.setState({
      testArr: selectedRows.slice(),
    });
  };

  handleRowPinned = () => {
    // const selectedRows = this.gridApi.getSelectedRows();
    // console.log('malang1....', selectedRows);
    // alert('행고정');
      ...
      <div>
        ...
        <div>
          <Grid
            ...
            // pinnedTopRowData={pmSheetDataList[0]}
            onSelectionChanged={this.onSelectionChanged}
            // onPinnedRowTopCount={this.onPinnedRowTopCount}
          />
        </div>
      </div>
    );
...
const withReducer = injectReducer({ key: 'aggrid', reducer });
