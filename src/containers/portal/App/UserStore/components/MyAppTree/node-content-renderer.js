...
class CustomThemeNodeContentRenderer extends Component {
  render() {
    ...
    const nodeContent = connectDragPreview(
      <div
        className={`${styles.row} rstcustom__row ${isLandingPadActive ? ` ${styles.rowLandingPad} rstcustom__rowLandingPad` : ''} ${isLandingPadActive && !canDrop ? ` ${styles.rowCancelPad} rstcustom__rowCancelPad` : ''} ${isSearchMatch ? ` ${styles.rowSearchMatch} rstcustom__rowSearchMatch` : ''} ${isSearchFocus ? ` ${styles.rowSearchFocus} rstcustom__rowSearchFocus` : ''} ${className ? ` ${className}` : ''}`}
        style={{
