...
class Item extends PureComponent {
  render() {
    /* eslint-disable */
    const { appId, categoryId, title, subTitle, starPoint, starTotal, registed, registCategory, registApp, appIcon } = this.props;
            ...
            <Popover
              ...
              content={
                <ul className="popoverType1 appListMenu">
                  <li>
                    <Button type="button" className="highlight icon-regst-tree" onClick={registCategory}>
                      카테고리 등록
                    </Button>
                  </li>
                  <li>
                    <Button type="button" className="icon-regst-app" onClick={registApp}>
