...
import MyAppCategoryModal from '../MyAppCategoryModal';
import reducer from './reducer';
import saga from './saga';
import * as selectors from './selectors';
import * as actions from './actions';
import AntRadiobox from '../../../components/uielements/radiobox.style';
import { LinkBtnLgtGray, BtnDkGray, LinkBtnList } from '../../../components/uielements/buttons.style';
        ...
        <StyleAppUpdateForm>
          <Form>
            ...
            <div className="buttonWrapper">
              <Link to="/store/appMain/MyApp" style={{ float: 'left' }}>
                <LinkBtnList>{intlObj.get(messages.list)}</LinkBtnList>
              </Link>
              <Link to={`/store/appMain/MyApp/MyAppDetail/${this.state.APP_ID}/${this.state.VER}`}>
...
const withSaga = injectSaga({ key: 'AppUpdateForm', saga });
const withReducer = injectReducer({ key: 'AppUpdateForm', reducer });
