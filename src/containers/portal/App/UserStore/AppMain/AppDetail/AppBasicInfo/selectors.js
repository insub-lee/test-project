...
const makeAppPageInfoData = () => createSelector(selectAppDetail, appBasicInfoState => appBasicInfoState.get('appPageInfoData'));

const selectView = state => state.get('common');

const currentView = () => createSelector(selectView, viewState => viewState.get('view'));

export { selectAppDetail, makeSelectAppBasicInfo, makeSelectAppProcess, makeSelectAppManual, makeSelectAppManagerList, currentView, makeAppPageInfoData };
