...
function getDockStyles(
  ...
  { size, isResizing, fullWidth, fullHeight, isOpen },
  dockFixedYn,
) {
  let posStyle;
  const absSize = fluid ?
  ...
  render() {
    ...
    return (
      <div style={Object.assign({}, styles.wrapper, { zIndex })} className="dockPos">
        ...
        <div
          style={dockStyles}
          onMouseLeave={this.onMouseLeaveVisibleDock}
          onMouseEnter={dockFixedYn === 'A' ? this.onMouseEnterInvisibleDock : () => {}}
        >
          {/* 리사이즈 막기 */}
          {/* <div style={resizerStyles} onMouseDown={this.handleMouseDown} /> */}
          <div
            style={resizerStyles}
            onClick={dockFixedYn === 'N' ? this.handleClick : () => {}}
          />
          <div
            style={styles.dockContent}
            onMouseEnter={this.onMouseEnterInvisibleDock}
          >
