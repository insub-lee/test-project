...
const uesrFilemanageReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.SET_USER_FILE_MANAGE:
      return state.set('userFileManage', action.userFileManage);
    default:
      return state;
  }
};

export default uesrFilemanageReducer;
