...
const setListState = state => ({
  ...
  deptRootId: state.listDeptRootId,
  pstnRootId: state.listPstnRootId,
...
class UserReg extends React.Component {
  constructor(prop) {
    ...
    this.state = {
      ...
      listDeptRootId: location === undefined ? 0 : location.deptRootId,
      listPstnRootId: location === undefined ? 0 : location.pstnRootId,
