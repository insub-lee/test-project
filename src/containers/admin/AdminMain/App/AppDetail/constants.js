export const GET_MY_APP_DETAIL = 'admin/AdminMain/App/AppDetail/GET_MY_APP_DETAIL';
export const APP_INFO = 'admin/AdminMain/App/AppDetail/APP_INFO';

export const SERVICE_STOP = 'admin/AdminMain/App/AppDetail/SERVICE_STOP';
