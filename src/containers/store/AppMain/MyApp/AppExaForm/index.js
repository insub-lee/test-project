...
import { LinkBtnLgtGray, LinkBtnList, BtnDkGray } from '../../../components/uielements/buttons.style';
        ...
        <li key={item.APV_REQ_ID}>
          ...
          <div className="authorItem">
            <div className="memPic">
              <img
                className="listImg"
                src={`http://skynet.skhynix.com/portalWeb/uploadfile/pictures/${item.EMP_NO}.jpg`}
...
const withReducer = injectReducer({ key: 'AppExaForm', reducer });
const withSaga = injectSaga({ key: 'AppExaForm', saga });
