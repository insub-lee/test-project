...
class AppBasicInfo extends React.Component {
  ...
  render() {
    ...
    const handleRegistCategory = () => feed.showConfirm(`${lang.get('NAME', this.props.resAppBasicInfo)} ${intlObj.get(messages.appInput)}`, `${intlObj.get(messages.catgAppInput)}`, registerCategorys);
          ...
          <ul className="appDetailInfo">
            <li>
              <div className="appTitle">
                <h2 className="ellipsis">
                  {lang.get('NAME', this.props.resAppBasicInfo)}
                </h2>
              </div>
              <div className="btnsWrapperTop">
                ...
                <Popover
                  ...
                  content={this.props.appManagerList.length > 0 ?
                    (
                      <AppMaNagerList
                  ...
                  trigger="click"
                >
                  <BtnWhiteArr className="demoPosBtn">
            ...
            <li>
              <ul className="appDetails">
                ...
                <li>{intlObj.get(messages.catg)}: {lang.get('APPCATGPATH', this.props.resAppBasicInfo)}</li>
                <li>{intlObj.get(messages.ver)}: {this.props.resAppBasicInfo.VER}</li>
                <li>{intlObj.get(messages.openDttm)}: {this.props.resAppBasicInfo.OPEN_DTTM}</li>
              </ul>
                  ...
                  (
                    <div className="btnsWrapperBottom">
                      ...
                      >
                        <div className="regstBtnsGroup">
                          ...
                          <BtnRedMnRegist
                            className="menu"
                            title={intlObj.get(messages.menuInput)}
                            onClick={handleRegistApp}
                          >
                      ...
                      >
                        <div className="regstBtnsGroup">
                          <BtnLgtGrayRegisted
                            title={intlObj.get(messages.apping)}
                          >
                    ...
                    <div className="btnsWrapperBottom">
                      ...
                      >
                        <div className="regstBtnsGroup">
                          <BtnLgtGrayRegisted
                            title={intlObj.get(messages.stopApping)}
                          >
                            {intlObj.get(messages.stopApping)}
                          </BtnLgtGrayRegisted>
                        </div>
                      </div>
                    </div>
