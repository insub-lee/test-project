...
const makeSelectAppScreenshotList = () => createSelector(
  selectAppDetail,
  appScreenshotListState => appScreenshotListState.get('appScreenshotList').toJS(),
);

const makeSelectAppExplain = () => createSelector(
  selectAppDetail,
  appScreenshotListState => appScreenshotListState.get('appExplain'),
);
const makeSelectRequiredAppList = () => createSelector(
  selectAppDetail,
...
export {
  selectAppDetail,
  makeSelectAppScreenshotList,
  makeSelectAppExplain,
  makeSelectRequiredAppList,
