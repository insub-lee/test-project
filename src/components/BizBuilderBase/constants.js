...
export const SET_IS_TASK_FAVORITE_REDUCER = `${prefix}SET_IS_TASK_FAVORITE_REDUCER`;
export const SET_TASK_FAVORITE_SAGA = `${prefix}SET_TASK_FAVORITE_SAGA`;
export const SET_REL_TYPE_REDUCER = `${prefix}SET_REL_TYPE_REDUCER`;
export const SET_VALIDATIONDATA_REDUCER = `${prefix}SET_VALIDATIONDATA_REDUCER`;
export const SET_LIST_ORDER_BY_FIELD_REDUCER = `${prefix}SET_LIST_ORDER_BY_FIELD_REDUCER`;
export const SET_CALL_API_EXTRA_PROPS_REDUCER = `${prefix}SET_CALL_API_EXTRA_PROPS_REDUCER`;
