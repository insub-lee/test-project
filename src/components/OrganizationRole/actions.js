...
export const getGroupData = ROLE_CD => ({
  type: actionType.GET_GROUP_DATA_SAGA,
  ROLE_CD,
});

export const getGroupMemberData = (ROLE_CD, ACNT_TYPE, ACNT_ID) => ({
  type: actionType.GET_GROUP_MEMBER_DATA_SAGA,
  ROLE_CD,
  ACNT_TYPE,
  ACNT_ID,
});
