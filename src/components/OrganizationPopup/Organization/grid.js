...
class Grid extends Component {
  ...
  //   // readMore부분은 아래 소스 참고하시면 될 거같아요
  //   // admin\AdminMain\NotifyAdmin\NotifyAdminList\index.js
  // }
  ...
  render() {
    ...
    return (
      <ReactDataGridWrapper gridHeight={isTab ? 393 : 436}>
        ...
        {/* <ScrollBar
          style={{ width: '100%', height: isTab ? 393 : 436 }}
          autoHide
          autoHideTimeout={1000}
          autoHideDuration={200}
          onUpdate={this.handleUpdate} // 무한스크롤
        >
          <ReactDataGrid
            ref={(node) => { this.grid = node; }}
            rowKey="EMP_NO"
