...
const SettingTab = ({ property: { viewTargetType, viewTargetId, boxes, groups, formStuffs, works }, action }) => {
  ...
  return <Settings type="formStuffs" target={formStuffs[targetIndex]} action={action} targetIndex={targetIndex} boxType={box.property.type} works={works} />;
};
