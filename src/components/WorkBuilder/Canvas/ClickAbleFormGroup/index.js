...
class ClickAbleFormGroup extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Form.Item label={formStuff.property.label}>{allFormStuffs[formStuff.type] && allFormStuffs[formStuff.type] && allFormStuffs[formStuff.type].previewRenderer(formStuff)}</Form.Item>
