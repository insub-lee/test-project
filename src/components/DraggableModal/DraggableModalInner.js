...
// class ContextProps extends DraggableModalContextMethods {
//     id: ModalID;
...
function DraggableModalInnerNonMemo({ id, modalState, dispatch, visible, children, title, initialWidth, initialHeight, ...otherProps }) {
  ...
  const style: React.CSSProperties = useMemo(() => ({ ...modalStyle, top: y, left: x, height }), [y, x, height]);
  ...
  console.debug(modalState, zIndex);
  return (
    <Modal
