...
class appSetting extends Component {
  constructor(props) {
    ...
    this.props.initWidgetSetting(Number(BIZGRP_ID), Number(PAGE_ID), Number(WIDGET_ID));
  }
...
appSetting.propTypes = {
  ...
  initWidgetSetting: PropTypes.func.isRequired,
  getWidgetList: PropTypes.func.isRequired,
  resetCategory: PropTypes.func.isRequired,
  updateBizGroupChgYn: PropTypes.func.isRequired,
};
...
export function mapDispatchToProps(dispatch) {
  return {
    initWidgetSetting: (BIZGRP_ID, PAGE_ID, WIDGET_ID) => dispatch(actions.initWidgetSetting(BIZGRP_ID, PAGE_ID, WIDGET_ID)),
    ...
    getWidgetListBizManage: PAGE_ID => dispatch(actionsBizManage.getWidgetList(PAGE_ID)),
    resetCategory: () => dispatch(resetCategory()),
    updateBizGroupChgYn: () => dispatch(actions.updateBizGroupChgYn()),
  };
}
