              ...
              <Table.Body>
                {
                  ...
                  ) : <Table.Row><Table.Cell style={{ display: 'none' }} /></Table.Row>
                }
                {
                  props.deptList.map((dept, index) => (
                    ...
                    <Table.Row key={dept.id} style={{ cursor: 'pointer' }}>
                      ...
                      <Table.Cell
                        style={{ display: this.state.delFlag ? 'block' : 'none' }}
                      >
                        <button
                          onClick={() => this.deptDel(index)}
                          className="delete"
                        >
                    ...
                    <Table.Row key={manager.EMP_NO} style={{ cursor: 'pointer' }}>
                      ...
                      >
                        ...
                        >
                          <img
                            className="listImg"
                            src={`http://skynet.skhynix.com/portalWeb/uploadfile/pictures/${manager.EMP_NO}.jpg`}
          ...
          <Table size="small" style={{ width: '100%' }}>
            <Table.Body>
              ...
              }
              {
                ...
                ) : <Table.Row><Table.Cell style={{ height: 0 }} /></Table.Row>
              }
              {
                props.userList.map((user, index) => (
                  <Table.Row key={user.EMP_NO} style={{ cursor: 'pointer' }}>
      ...
      <div align="left">
        <UserSearchWrapper>
          <div className="mSearchWrapper" style={{ position: 'relative', padding: 0, margin: 0 }}>
            {this.state.scroll === 0 && this.state.scroll !== null ?
              RenderSearchView(this.state)
              :
              RenderSearchViewScroll(this.state)
            }
          </div>
        </UserSearchWrapper>
      </div>
