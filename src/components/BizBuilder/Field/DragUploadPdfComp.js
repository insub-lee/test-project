...
class DragUploadPdfComp extends Component {
  state = {
    fileInfo: [],
  };
          ...
          <div className="fileZone" style={{ position: 'absolute', top: '10px', marginLeft: '10px' }}>
            {fileList.map(file => (
              <div style={{ height: '25px' }}>
                ...
                <Icon onClick={() => this.onClickRemoveFile(file)} type="delete" style={{ fontSize: '15px', verticalAlign: 'middle', marginLeft: '10px' }} />
              </div>
            ))}
          </div>
        )}
...
DragUploadPdfComp.propTypes = {
  detail: PropTypes.array,
};

DragUploadPdfComp.defaultProps = {
  detail: [],
};

export default DragUploadPdfComp;
