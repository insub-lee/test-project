  ...
  render() {
    ...
    return [
      <div className="popoverItem popoverItemInput">
        <span className="spanLabel">FormData Format</span>
        <Input
          style={{ width: '100%' }}
      ...
      <div className="popoverItem popoverItemInput">
        <span className="spanLabel">View Format</span>
        <Input
          style={{ width: '100%' }}
          defaultValue={(configInfo && configInfo.property && configInfo.property.viewformat) || 'YYYY-MM'}
          placehoder="예) YYYY-MM 형식으로 작성해 주십시오"
          onChange={e => this.handleChangeConfigData('viewformat', e.target.value)}
        />
      </div>,
    ];
  }
