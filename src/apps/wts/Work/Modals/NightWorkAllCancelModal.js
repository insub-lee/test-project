...
class NightWorkAllCancelModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isOpen: false,
...
NightWorkAllCancelModal.propTypes = {
  callbackHandler: PropTypes.func,
};

NightWorkAllCancelModal.defaultProps = {
  callbackHandler: () => false,
};

export default NightWorkAllCancelModal;
