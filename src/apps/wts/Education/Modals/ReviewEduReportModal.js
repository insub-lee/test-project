...
class ReviewEduReportModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isOpen: false,
  ...
  handleOpenModal(postno) {
    this.setState({ isOpen: true, postno }, () => {
      //
    });
  }
  ...
  saveData(e) {
    e.preventDefault();
    const checkKeys = ['curriculum', 'searchDt', 'study_content', 'study_feel'];
    ...
    if (!hasNoValue) {
      console.debug('# Report Insert', payload);
                ...
                <StyledCommonForm onSubmit={this.saveData} autoComplete="off">
                  <ul className="sub_form small2 has_margin">
                    <li>
                      ...
                      <input type="text" className="input" name="curriculum" id="search-text-input" />
                    </li>
                    <li>
                      <label className="title" htmlFor>
                        교육일자
                      ...
                      <div style={{ width: 150 }}>
                        <DatePicker values={datePicker.getIn(['edudt', 'values'])} single />
                      </div>
                    </li>
                    <li style={{ padding: 0 }}>
                      ...
                      <div style={{ padding: '10px 0' }}>
                        <textarea name="study_content" id="" cols="30" rows="10" maxLength={300} placeholder="교육내용을 작성하세요.(300자 내)" />
                      </div>
                    </li>
                    <li style={{ padding: 0 }}>
                      <label className="" htmlFor>
                      ...
                      <div style={{ padding: '10px 0' }}>
                        <textarea name="study_feel" id="" cols="30" rows="10" maxLength={200} placeholder="소감을 작성하세요.(200자 내)" />
                      </div>
                    </li>
                  </ul>
...
ReviewEduReportModal.propTypes = {
  callbackHandler: PropTypes.func,
};

ReviewEduReportModal.defaultProps = {
  callbackHandler: () => false,
};

export default ReviewEduReportModal;
