...
class ChiefOpinion extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isOpen: false,
  ...
  saveData(e) {
    ...
    if (!payload.chief_opinion || payload.chief_opinion.trim() === '') {
      alert('의견을 작성해주세요.');
    } else {
...
ChiefOpinion.propTypes = {
  callbackHandler: PropTypes.func,
};

ChiefOpinion.defaultProps = {
  callbackHandler: () => false,
};

export default ChiefOpinion;
