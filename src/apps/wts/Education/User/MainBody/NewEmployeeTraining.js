...
import ChiefEduManageModal from '../../Modals/ChiefEduManageModal';
...
class NewEmployeeTraining extends React.Component {
  constructor(props) {
    ...
    this.chiefEduManageModal = React.createRef();
  ...
  handleOpenManageModal(planseq) {
    console.debug('# open modal ', planseq);
    this.chiefEduManageModal.current.handleOpenModal(planseq);
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <ChiefEduManageModal ref={this.chiefEduManageModal} site={site} />
