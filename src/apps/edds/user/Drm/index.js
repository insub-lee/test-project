              ...
              <div className="drm_con drm_con01">
                ...
                <div className="drm_box drm_text">
                  <ul>
                    ...
                    <li>
                      1.{' '}
                      <a href="/down/file/drm/2" download>
                        [클라이언트 설치 프로그램]
                      </a>
                      을 클릭하여 설치 파일을 다운로드합니다.
                    </li>
                    <li>
                      2. 다운로드받은 <span className="pointcolor">DocSafer.exe 파일을 실행</span>합니다.
                    </li>
              ...
              <div className="drm_con drm_con02">
                ...
                <div className="drm_box drm_text">
                  <ul>
                    <li>
                      1.{' '}
                      <a href="/down/file/drm/3" download>
                        [클라이언트 삭제 프로그램]
                      </a>
                      을 클릭하여 삭제 파일을 다운로드합니다.
                    </li>
                    <li>
                      2. 다운로드받은 <span className="pointcolor">DocSafer_delete.exe 파일을 실행</span>합니다.
                    </li>
                    <li>3. 확인 버튼을 클릭합니다. (확인 버튼 클릭 시, Document Safer가 삭제됩니다) </li>
                    <li>
                      4. <span className="pointcolor">"이 메세지를 다시 표시하지 마십시오"</span>에 체크하고, 무시 버튼을 클릭합니다.
                    </li>
