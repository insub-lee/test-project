...
const makeSelectCategoryMapList = key => createSelector(makeSelectNoticeState, state => state.getIn(['notice', key]));
const makeSelectedFilteredData = () => createSelector(makeSelectNoticeState, state => state.getIn(['noticeData']));
