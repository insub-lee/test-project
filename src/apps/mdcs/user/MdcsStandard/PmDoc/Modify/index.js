...
class PmDocModify extends Component {
  state = {
    spec: false,
    dw: false,
    keyword: '',
              ...
              <div className="tableBody">
                <Row>
                  ...
                  <div className="rightTable">
                    ...
                    <Col span={8}>
                      <Input value={formData && formData.VERSION && formData.VERSION.split('.')[0]} />
                    </Col>
                  </div>
                </Row>
                <Row>
