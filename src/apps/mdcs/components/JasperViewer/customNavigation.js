...
export const CustomZoomInBtn = props => {
  ...
  if (scale.toFixed(2) === checkScale.toFixed(2)) {
    return (
      <Button className="zoomInBtn" type="dashed" shape="circle" size="small" disabled>
  ...
  return (
    <Button className="zoomInBtn" type="dashed" shape="circle" onClick={handleZoomIn} size="small">
      <ZoomInOutlined style={{ color: '#000000' }} />
    </Button>
  );
};
...
export const CustomZoomOutBtn = props => {
  ...
  if (scale.toFixed(2) === checkScale.toFixed(2)) {
    return (
      <Button className="zoomOutBtn" type="dashed" shape="circle" size="small" disabled>
  ...
  return (
    <Button className="zoomOutBtn" type="dashed" shape="circle" onClick={handleZoomOut} size="small">
      <ZoomOutOutlined style={{ color: '#000000' }} />
    </Button>
  );
};
...
export const CustomResetZoomBtn = props => {
  ...
  if (scale.toFixed(2) === defaultScale.toFixed(2)) {
    return (
      <Button className="zoomResetBtn" type="dashed" shape="circle" size="small" disabled>
  ...
  return (
    <Button className="zoomResetBtn" type="dashed" shape="circle" onClick={handleResetZoom} size="small">
      <RedoOutlined style={{ color: '#000000' }} />
    </Button>
  );
};
...
const CustomNavigation = props => {
  ...
  const { handlePrevClick, handleNextClick, handleZoomIn, handleZoomOut, handleResetZoom, scale, defaultScale, maxScale, minScale } = props;
  return (
