...
const makeGetWeatherList = () => createSelector(selectApps, messageState => messageState.get('itemWeatherList'));
...
export { selectApps, makeGetWeatherList, makeGetWidgetId, makeGetPageId };
