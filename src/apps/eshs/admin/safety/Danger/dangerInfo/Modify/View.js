...
const tagArray = (onChangeData, formData) => [
  <>
    ...
    <td colSpan={2}>
      <AntdInputNumber
        ...
        style={{ width: 100 }}
        value={formData.INFO_DATA ? formData.INFO_DATA.JAEHAE : formData.JAEHAE}
      />
      건
    </td>
  </>,
  <>
    ...
    <td colSpan={2}>
      <AntdInputNumber
        ...
        style={{ width: 100 }}
        value={formData.INFO_DATA ? formData.INFO_DATA.ACHA : formData.ACHA}
      />
      건
    </td>
  </>,
  ...
  <>
    <td colSpan={3} rowSpan={1}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.EMP_WOMAN : formData.EMP_WOMAN} onChange={e => onChangeData(`EMP_WOMAN`, e.target.checked)}>
        여성근로자
      </Checkbox>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.EMP_NEW : formData.EMP_NEW} onChange={e => onChangeData(`EMP_NEW`, e.target.checked)}>
        1년 미만 미숙련자
      </Checkbox>
    </td>
  </>,
  <>
    <td colSpan={3} rowSpan={1}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.EMP_OLD : formData.EMP_OLD} onChange={e => onChangeData(`EMP_OLD`, e.target.checked)}>
        고령근로자
      </Checkbox>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.EMP_TEMP : formData.EMP_TEMP} onChange={e => onChangeData(`EMP_TEMP`, e.target.checked)}>
        비정규직 근로자
      </Checkbox>
    </td>
  </>,
  <>
    <td colSpan={3} rowSpan={1}>
      <Checkbox
        value={formData.INFO_DATA ? formData.INFO_DATA.EMP_FOREIGN : formData.EMP_FOREIGN}
        onChange={e => onChangeData(`EMP_FOREIGN`, e.target.checked)}
      >
        외국인 근로자
      </Checkbox>
      <Checkbox
        value={formData.INFO_DATA ? formData.INFO_DATA.EMP_DISABLE : formData.EMP_DISABLE}
        onChange={e => onChangeData(`EMP_DISABLE`, e.target.checked)}
      >
        장애 근로자
      </Checkbox>
    </td>
  ...
  <>
    <th>교대작업 유무</th>
    <td colSpan={2}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.WORK_Y : formData.WORK_Y} onChange={e => onChangeData(`WORK_Y`, e.target.checked)}>
        유
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.WORK_N : formData.WORK_N} onChange={e => onChangeData(`WORK_N`, e.target.checked)}>
        무
      </Checkbox>
    </td>
  </>,
  <>
    <th>운반수단 유무</th>
    <td colSpan={2}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.MOVE_Y : formData.MOVE_Y} onChange={e => onChangeData(`MOVE_Y`, e.target.checked)}>
        기계
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.MOVE_N : formData.MOVE_N} onChange={e => onChangeData(`MOVE_N`, e.target.checked)}>
        인력
      </Checkbox>
    </td>
  </>,
  <>
    ...
    <td colSpan={2}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.AGREE_Y : formData.AGREE_Y} onChange={e => onChangeData(`AGREE_Y`, e.target.checked)}>
        유
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.AGREE_N : formData.AGREE_N} onChange={e => onChangeData(`AGREE_N`, e.target.checked)}>
        무
      </Checkbox>
    </td>
  </>,
  <>
    ...
    <td colSpan={2} rowSpan={2}>
      <AntdInputNumber
        ...
        value={formData.INFO_DATA ? formData.INFO_DATA.WEIGHT_KG : formData.WEIGHT_KG}
      />
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.WEIGHT_UP : formData.WEIGHT_UP} onChange={e => onChangeData(`WEIGHT_UP`, e.target.checked)}>
        들기
      </Checkbox>
      <Checkbox
        value={formData.INFO_DATA ? formData.INFO_DATA.WEIGHT_PUSH : formData.WEIGHT_PUSH}
        onChange={e => onChangeData(`WEIGHT_PUSH`, e.target.checked)}
      >
        밀기
      </Checkbox>
      <Checkbox
        value={formData.INFO_DATA ? formData.INFO_DATA.WEIGHT_PULL : formData.WEIGHT_PULL}
        onChange={e => onChangeData(`WEIGHT_PULL`, e.target.checked)}
      >
        끌기
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.WEIGHT_ETC : formData.WEIGHT_ETC} onChange={e => onChangeData(`WEIGHT_ETC`, e.target.checked)}>
        기타
      </Checkbox>
    </td>
  </>,
  ...
  <>
    <th>작업환경측정 측정유무</th>
    <td colSpan={2}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.ENV_Y : formData.ENV_Y} onChange={e => onChangeData(`ENV_Y`, e.target.checked)}>
        측정
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.ENV_N : formData.ENV_N} onChange={e => onChangeData(`ENV_N`, e.target.checked)}>
        미측정
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.ENV_Z : formData.ENV_Z} onChange={e => onChangeData(`ENV_Z`, e.target.checked)}>
        해당무
      </Checkbox>
    </td>
  </>,
  <>
    ...
    <td colSpan={2}>
      <AntdInputNumber
        ...
        value={formData.INFO_DATA ? formData.INFO_DATA.ENV_NOISE : formData.ENV_NOISE}
      />
      dB
    </td>
  </>,
  <>
    ...
    <td colSpan={2}>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.EDU_Y : formData.EDU_Y} onChange={e => onChangeData(`EDU_Y`, e.target.checked)}>
        유
      </Checkbox>
      <Checkbox value={formData.INFO_DATA ? formData.INFO_DATA.EDU_N : formData.EDU_N} onChange={e => onChangeData(`EDU_N`, e.target.checked)}>
        무
      </Checkbox>
    </td>
  </>,
                  ...
                  <tr>
                    <td align="center" colSpan="2">
                      <AntdSelect
                        className="select-sm"
                        style={{ width: '100%' }}
                        value={formData.INFO_DATA ? formData.INFO_DATA[`M_CD${index + 1}`] : formData[`M_CD${index + 1}`]}
                    ...
                    <td align="center">
                      <AntdInputNumber
                        className="ant-input-number-sm"
                        style={{ width: 100 }}
                        defaultValue={formData.INFO_DATA && formData.INFO_DATA[`M_QTY${index + 1}`]}
                    ...
                    <td align="center">
                      <AntdSearchInput
                        ...
                        value={formData.INFO_DATA && formData.INFO_DATA[`C_NAME${index + 1}`]}
                        readOnly
