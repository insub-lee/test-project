...
import { VIEW_TYPE, META_SEQ, FIRE_CODE } from 'apps/eshs/admin/safety/InspectionTarget/FireEbShower/internal_constants';
import IssueNote from 'apps/eshs/admin/safety/InspectionTarget/IssueNote';
import * as CustomButtons from 'apps/eshs/admin/safety/InspectionTarget/FireEbShower/Buttons';
...
class ViewPage extends Component {
  ...
  modalTitle = () => {
    ...
    switch (pageMetaSeq) {
      case META_SEQ.VIEW_INSPECTION_BY_CHIP:
        return 'EYE & BODY SHOWER 점검 History';
      case META_SEQ.VIEW_INSPECTION_BY_POSITON_NO:
        return 'EYE & BODY SHOWER 점검 History';
      case META_SEQ.INPUT_ISSUE_NOTE:
        return 'Issue 등록';
