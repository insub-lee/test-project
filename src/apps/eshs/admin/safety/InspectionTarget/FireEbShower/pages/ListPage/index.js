...
import { address, VIEW_TYPE, META_SEQ } from 'apps/eshs/admin/safety/InspectionTarget/FireEbShower/internal_constants';
...
const ListPage = props => {
  ...
  const modalTitle = () => {
    if (activateRegModal) return 'EYE & BODY SHOWER 신규등록';
    if (activateDetailModal) return 'EYE & BODY SHOWER 점검';
    if (activateUsageModal) return 'EYE & BODY SHOWER 사용/미사용 등록';
    return '';
  };
