...
import { address, VIEW_TYPE, META_SEQ } from 'apps/eshs/admin/safety/InspectionTarget/FireDpump/internal_constants';
...
const ListPage = props => {
  ...
  const modalTitle = () => {
    if (activateRegModal) return 'DI동 소방펌프 신규등록';
    if (activateDetailModal) return 'DI동 소방펌프 점검';
    if (activateUsageModal) return 'DI동 소방펌프 사용/미사용 등록';
    return '';
  };
