...
import { address, VIEW_TYPE, META_SEQ } from 'apps/eshs/admin/safety/InspectionTarget/FireAirLineMask/internal_constants';
...
const ListPage = props => {
  ...
  const modalTitle = () => {
    if (activateRegModal) return 'Air Line Mask함 신규등록';
    if (activateDetailModal) return 'Air Line Mask함 점검';
    if (activateUsageModal) return 'Air Line Mask함 사용/미사용 등록';
    return '';
  };
