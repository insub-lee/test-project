...
import { address, VIEW_TYPE, META_SEQ } from 'apps/eshs/admin/safety/InspectionTarget/FirePkg/internal_constants';
...
const ListPage = props => {
  ...
  const modalTitle = () => {
    if (activateRegModal) return 'PKG소화설비 신규등록';
    if (activateDetailModal) return 'PKG소화설비 점검';
    if (activateUsageModal) return 'PKG소화설비 사용/미사용 등록';
    return '';
  };
