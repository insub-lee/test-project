...
export const sapUsageColumn = [
  ...
  },
  {
    ...
    children: [
      {
        headerName: '2018년 제품사용량',
        field: '2018_PRODUCT_USAGE',
        filter: 'agTextColumnFilter',
        sortable: true,
        width: 140,
      },
      {
        headerName: '2018년 물질사용량',
        field: '2018_MATERIAL_USAGE',
        filter: 'agTextColumnFilter',
        sortable: true,
        width: 140,
      },
      {
        headerName: '2019년 제품사용량',
        field: '2019_PRODUCT_USAGE',
        filter: 'agTextColumnFilter',
        sortable: true,
        width: 140,
      },
      {
        headerName: '2019년 물질사용량',
        field: '2019_MATERIAL_USAGE',
        filter: 'agTextColumnFilter',
        sortable: true,
        width: 140,
      },
      {
        headerName: '2020년 제품사용량',
        field: '2020_PRODUCT_USAGE',
        filter: 'agTextColumnFilter',
        sortable: true,
        width: 140,
      },
      {
        headerName: '2020년 물질사용량',
        field: '2020_MATERIAL_USAGE',
        filter: 'agTextColumnFilter',
        sortable: true,
        width: 140,
      },
