...
class List extends React.Component {
  ...
  handleInputClick = () => {
    ...
    if (isModified) {
      ...
      return submitHandlerBySaga(
        id,
        'PUT',
        `/api/eshs/v1/common/eshschemicalsafetyspecialhealth`,
  ...
  handleDeleteConfirm = () => {
    const { sagaKey: id, submitHandlerBySaga } = this.props;
    const { requestValue } = this.state;
    return submitHandlerBySaga(id, 'DELETE', `/api/eshs/v1/common/eshschemicalsafetyspecialhealth`, requestValue, this.getMaterialList);
  };
    ...
    const apiArr = [
      {
        key: 'materialList',
        type: 'GET',
        url: '/api/eshs/v1/common/eshschemicalsafetyspecialhealth',
      },
    ];
    ...
    const apiArr = [
      {
        key: 'subMaterials',
        type: 'GET',
        url: `/api/eshs/v1/common/eshschemicalsafetyspecialhealthsub?PARENT_ID=${record.HEALTH_ID}`,
      },
    ];
    ...
    return (
      <>
        ...
        <Modal
          ...
          apiUrl="/api/eshs/v1/common/eshschemicalsafetyspecialhealth"
