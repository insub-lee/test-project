...
import { Input, InputNumber, Select, Popconfirm, Checkbox, message } from 'antd';
...
class List extends React.Component {
  ...
  handleInputClick = () => {
    ...
    if (isModified) {
      ...
      return submitHandlerBySaga(id, 'PUT', `/api/eshs/v1/common/eshschemicalsafetypsm`, requestValue, (key, response) =>
    ...
    return submitHandlerBySaga(id, 'POST', `/api/eshs/v1/common/eshschemicalsafetypsm`, requestValue, (key, response) =>
  ...
  handleDeleteConfirm = () => {
    ...
    return submitHandlerBySaga(id, 'DELETE', `/api/eshs/v1/common/eshschemicalsafetypsm`, requestValue, (key, response) =>
