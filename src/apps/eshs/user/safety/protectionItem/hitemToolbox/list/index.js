...
import { Table, InputNumber, Select, Modal, Input } from 'antd';
...
class List extends React.Component {
  ...
  handleInputChange = (key, id, value) => {
    console.debug(id, key, value);
    this.setState(prevState => ({ requestValue: Object.assign(prevState.requestValue[id], { [key]: value }) }));
  };

  render() {
    const { columns, yearList, handleSearchChange, handleModalVisible, handleModalClose, handleDeptSelect } = this;
