...
class InputPage extends Component {
  ...
  // 야외행사 신청번호 찾기 모달에서 RowOnclick
  customRowOnclick = record => {
    const { sagaKey: id, setViewPageData, changeViewPage } = this.props;
    this.setState(
      {
        modalVisible: false,
      },
        ...
        <>
          <StyledWrap className={viewPageData.viewType}>
            <Sketch {...bodyStyle}>
              ...
              <StyledButtonWrapper className="btn-wrap-right" style={{ marginBottom: '10px' }}>
