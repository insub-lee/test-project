        ...
        <table>
          ...
          <thead>
            ...
            <tr>
              <td></td>
              <td>
                <Input name="EI_AREA" value={itemData.EI_AREA || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="PREVENTION_EQUIP" value={itemData.PREVENTION_EQUIP || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="INFLOW_AREA" value={itemData.INFLOW_AREA || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="DISCHARGE_MATTER" value={itemData.DISCHARGE_MATTER || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="PPM_WARNING" value={itemData.PPM_WARNING || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="PPM_SHOTDOWN" value={itemData.PPM_SHOTDOWN || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="PPM_YEAR_AVERAGE" value={itemData.PPM_YEAR_AVERAGE || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="W1" value={itemData.W1 || ''} onChange={this.handleInputOnChange} />
              </td>
              <td>
                <Input name="LEGISLATION" value={itemData.LEGISLATION || ''} onChange={this.handleInputOnChange} />
              </td>
            </tr>
            <tr>
              <td rowSpan={2}></td>
              <td rowSpan={2}>Area</td>
              <td rowSpan={2}>방지시설</td>
              <td rowSpan={2}>
                오염물질
                <br />
                유입 Area
              </td>
              <td rowSpan={2}>배출물질명</td>
              <td colSpan={2}>관리기준(ppm)</td>
              <td rowSpan={2}>
                배출농도
                <br />
                (ppm/년평균)
              </td>
              <td colSpan={2}>환경영향수준</td>
            </tr>
            <tr>
              <td>
                자체기준
