...
class QuestionnaireView extends Component {
  ...
  render() {
    const { qData, saveType, userInfo } = this.state;
              ...
              <table className="question-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {userInfo.REGNO && (
                        `${userInfo.REGNO.substring(0, 6)} - ${userInfo.REGNO.substring(6, 13)}`
                      )}
                    </td>
                    <th>사업장명</th>
                    <td>{this.getBareaCdName(userInfo.BAREA_CD)}</td>
                  </tr>
                  <tr>
                    <th>부서</th>
                  ...
                  <tr>
                    <td colSpan={4} className="radio-td">
                      <Radio.Group
                        className="w25"
                        buttonStyle="solid"
                        value={qData.CANCER_QUESTION4 && qData.CANCER_QUESTION4.CHECK9 ? qData.CANCER_QUESTION4.CHECK9 : ''}
