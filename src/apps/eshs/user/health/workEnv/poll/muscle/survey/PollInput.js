...
class PollInput extends Component {
  ...
  checkOpenServey = () => {
    ...
    const apiInfo = {
      ...
      params: { PARAM: { type: 'CHECK_OPEN_SURVEY', surveyType: 'muscle' } },
    };
    getCallDataHandlerReturnRes(id, apiInfo, this.checkOpenServeyCallback);
  };

  checkOpenServeyCallback = (id, response) => {
    const { profile, spinningOff } = this.props;
    const { formData } = this.state;
    const { userInfo, result } = response;
    if (result > 0) {
      const userDetail = this.getUserDetail(userInfo.REGNO);
      this.setState({
        isload: true,
        isOpen: true,
        formData: {
  ...
  getUserDetail = regNo => {
    if (regNo === '0' || regNo === '') return { AGE: '', SEX: '1' };
  ...
  save = () => {
    ...
    spinningOn();
    return submitHandlerBySaga(sagaKey, 'POST', '/api/eshs/v1/common/health/eshsHealthPoll', { PARAM: submitData }, (id, res) => {
      if (res && res.result >= 2) {
        spinningOff();
  ...
  render() {
    const { isload, isOpen, formData, questionData } = this.state;
    const qck = (formData && formData.QCK) || '';
    const q4 = (formData && formData.Q4) || '';
    const q6 = (formData && formData.Q6) || '';
    const q11 = (questionData && questionData.Q11) || '';
      ...
      <Styled>
        {isOpen ? (
          <>
            <StyledContentsWrapper>
              ...
              <div className="examination-area">
                ...
                <div className="question-item">
                  <p className="question-txt">
                    <span className="question-num">2. </span>귀하의 하루 평균 가사노동시간(밥하기, 빨래하기, 청소하기, 2살 미만의 아이 돌보기 등)은 얼마나
                    됩니까?
                  </p>
                  <div className="question-article">
                ...
                <div className="question-item">
                  <p className="question-txt">
                    <span className="question-num">4. </span>과거에 운동 중 혹은 사고로 (교통사고, 넘어짐 추락 등) 인해 손/손가락/손목, 팔/팔꿈치, 어깨, 목,
                    허리, 무릎 부의를 다친 적이 있습니까?
                  </p>
                  <div className="question-article">
                ...
                <div className="examination-area" style={{ float: 'left', width: '90%' }}>
                  <div className="question-item">
                    <p className="add-title">
                      Ⅱ. 지난 1년 동안 손/손가락/손목, 팔/팔꿈치, 어깨, 허리, 무릎 중 어느 한 부위 에서라도 귀하의 직업과 관련하여 통증이나 불편함(통증,쑤시는
                      느낌, 뻣뻣함, 화끈거리는 느낌, 무감각 혹은 찌릿찌릿함 등)을 느끼신 적이 있습니까?(오른쪽 그림을 참고하십시오)
                    </p>
                    <div className="question-article">
                  ...
                  <table className="question-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q12', e.target.value)}
                            style={{ display: qck === '2' || q11 === '4' ? 'none' : '' }}
                          >
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q22', e.target.value)}
                            style={{ display: qck === '2' || q21 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">1일 미만</Radio>
                            <br />
                            <Radio value="2">1일 - 1주일</Radio>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q32', e.target.value)}
                            style={{ display: qck === '2' || q31 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">1일 미만</Radio>
                            <br />
                            <Radio value="2">1일 - 1주일</Radio>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q42', e.target.value)}
                            style={{ display: qck === '2' || q41 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">1일 미만</Radio>
                            <br />
                            <Radio value="2">1일 - 1주일</Radio>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q52', e.target.value)}
                            style={{ display: qck === '2' || q51 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">1일 미만</Radio>
                            <br />
                            <Radio value="2">1일 - 1주일</Radio>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q62', e.target.value)}
                            style={{ display: qck === '2' || q61 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">1일 미만</Radio>
                            <br />
                            <Radio value="2">1일 - 1주일</Radio>
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q13', e.target.value)}
                            style={{ display: qck === '2' || q11 === '4' ? 'none' : '' }}
                          >
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q23', e.target.value)}
                            style={{ display: qck === '2' || q21 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">통증 없음</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q33', e.target.value)}
                            style={{ display: qck === '2' || q31 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">통증 없음</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q43', e.target.value)}
                            style={{ display: qck === '2' || q41 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">통증 없음</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q53', e.target.value)}
                            style={{ display: qck === '2' || q51 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">통증 없음</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q63', e.target.value)}
                            style={{ display: qck === '2' || q61 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">통증 없음</Radio>
                            <br />
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q14', e.target.value)}
                            style={{ display: qck === '2' || q11 === '4' ? 'none' : '' }}
                          >
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q24', e.target.value)}
                            style={{ display: qck === '2' || q21 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">6개월에 1번</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q34', e.target.value)}
                            style={{ display: qck === '2' || q31 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">6개월에 1번</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q44', e.target.value)}
                            style={{ display: qck === '2' || q41 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">6개월에 1번</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q54', e.target.value)}
                            style={{ display: qck === '2' || q51 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">6개월에 1번</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q64', e.target.value)}
                            style={{ display: qck === '2' || q61 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">6개월에 1번</Radio>
                            <br />
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q15', e.target.value)}
                            style={{ display: qck === '2' || q11 === '4' ? 'none' : '' }}
                          >
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q25', e.target.value)}
                            style={{ display: qck === '2' || q21 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">예</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q35', e.target.value)}
                            style={{ display: qck === '2' || q31 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">예</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q45', e.target.value)}
                            style={{ display: qck === '2' || q41 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">예</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q55', e.target.value)}
                            style={{ display: qck === '2' || q51 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">예</Radio>
                            <br />
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q65', e.target.value)}
                            style={{ display: qck === '2' || q61 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">예</Radio>
                            <br />
                      ...
                      <tr>
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q16', e.target.value)}
                            style={{ display: qck === '2' || q11 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">
                              병원 혹은
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q26', e.target.value)}
                            style={{ display: qck === '2' || q21 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">
                              병원 혹은
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q36', e.target.value)}
                            style={{ display: qck === '2' || q31 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">
                              병원 혹은
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q46', e.target.value)}
                            style={{ display: qck === '2' || q41 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">
                              병원 혹은
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q56', e.target.value)}
                            style={{ display: qck === '2' || q51 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">
                              병원 혹은
                        ...
                        <td style={{ textAlign: 'left' }}>
                          <Radio.Group
                            onChange={e => this.changeQuestionData('Q66', e.target.value)}
                            style={{ display: qck === '2' || q61 === '4' ? 'none' : '' }}
                          >
                            <Radio value="1">
                              병원 혹은
          ...
          <div style={{ width: '100%', textAlign: 'center', padding: '50px' }}>
            <span style={{ fontWeight: 600, fontSize: 20 }}>근골격계질환 설문조사 진행기간이 아닙니다.</span>
          </div>
        )}
      </Styled>
    );
