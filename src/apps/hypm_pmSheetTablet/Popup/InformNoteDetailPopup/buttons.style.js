...
//  Dark Blue (어두운 블루)
const BtnSearchDkBlue = styled.button`
  min-width:60px;
  height:30px;
  padding: 0 15px;
  background-color:#6681A4;
  border: 1px solid #dadada;
  border-radius: 3px;
  font-size:13px;
  color:#FFFFFFFF;
...
/* Search 등록 */
// background:#ffffff url(${SearchIcon}) no-repeat 7px 50%;
const BtnRedSearch = styled.button`
  min-width: 130px;
  height: 32px;
  padding: 0 15px;
  border: 0;
...
export {
  ...
  BtnBizPreview, BtnBizSettings, BtnWhiteAttdAdd, BtnSearchDkGray, BtnApprovalLightRed, BtnApprovalPrev, BtnApprovalNext, BtnRedSearch, BtnSearchDkBlue,
};
