...
export const getAttendGroupList = () => ({
  type: actionType.GET_ATTEND_GROUP_LIST_SAGA,
});

export const getAttendMemberList = GRP_ID => ({
  type: actionType.GET_ATTEND_MEMBER_LIST_SAGA,
  GRP_ID,
});
