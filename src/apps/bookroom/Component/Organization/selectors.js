...
const selectOrg = state => state.get('bookroomOrg');
...
const makeSelectAttendGroupList = () => createSelector(
  selectOrg,
  org => org.get('attendGroupList').toJS(),
);

const makeSelectAttendMemberList = () => createSelector(
  selectOrg,
  org => org.get('attendMemberList').toJS(),
);
...
export {
  ...
  makeSelectAttendGroupList,
  makeSelectAttendMemberList,
};
