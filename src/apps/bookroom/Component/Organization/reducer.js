...
const orgReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionType.GET_TREE_DATA_PROFILE:
      ...
      return state.set('treeData', action.treeData);
    case actionType.GET_ATTEND_GROUP_LIST:
      return state.set('attendGroupList', action.attendGroupList)
        .set('EMP_ID', action.EMP_ID);
    case actionType.GET_ATTEND_MEMBER_LIST:
      return state.set('attendMemberList', action.attendMemberList);
    default:
      return state;
  }
};
