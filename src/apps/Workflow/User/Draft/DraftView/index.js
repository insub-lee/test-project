...
class DraftView extends Component {
  ...
  render() {
    const { CATE, visible, draftDetail, signline, draftHistory, visibleOpinionModal, setVisibleOpinionModal } = this.props;
      ...
      >
        <StyleDraftView>
          <div>
            ...
            <div className="content" style={{ minHeight: '400px' }}></div>
...
export default compose(withSaga, withReducer, withConnect)(DraftView);
