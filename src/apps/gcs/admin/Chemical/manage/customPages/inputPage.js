...
class InputPage extends Component {
  ...
  componentDidMount() {
    const { sagaKey: id, getProcessRule, workInfo, workPrcProps, relType, setRelType, initMonth, initSite, changeFormData } = this.props;
    ...
    if (initMonth) changeFormData(id, 'CHEMMDT', initMonth);
    if (initSite) changeFormData(id, 'SITE', initSite);
  }
  ...
  saveTask = (id, reloadId) => {
    ...
    saveTask(id, reloadId, this.changeTaskCallback, changeIsLoading);
  };
...
InputPage.propTypes = {
  ...
  initSite: PropTypes.string,
  initMonth: PropTypes.string,
