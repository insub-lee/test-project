...
const makeGetBannerList = () => createSelector(
  selectApps,
  messageState => messageState.get('itemBannerList'),
);
...
const makeGetBanner = () => createSelector(
  selectBanners,
  messageState => messageState.get('cashItem'),
)
