    ...
    () => [
      {
        ...
        formJson: [
          ...
          { type: 'password', option: { label: '비밀번호', name: 'pwd', placeholder: '비밀번호를 입력해주세요.', value: '', required: false }, seq: 2 },
      ...
      },
      {
        ...
        formJson: [
          ...
          {
            type: 'richTextEditor',
            option: { label: '내용', name: 'textarea-1542189210177', placeholder: '내용을 입력하세요.', value: '', required: true },
            seq: 2,
          },
          { type: 'password', option: { label: '비밀번호', name: 'pwd', placeholder: '비밀번호를 입력해주세요.', value: '', required: false }, seq: 3 },
