              ...
              <div className="border-layer">
                ...
                <div className="layer-body fixHeight500">
                  <List
                    ...
                    renderItem={item => (
                      <List.Item actions={[<Button htmlType="button" disabled={item.STATUS > 0 && item.APP_ID && item.APP_ID > 0} onClick={() => postRegistWBApp(item.NAME_KOR, item.WORK_ID)}>등록</Button>]}>
