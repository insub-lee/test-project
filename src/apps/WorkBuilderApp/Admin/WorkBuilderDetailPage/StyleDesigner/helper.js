    ...
    rows: [
      {
        ...
        gutter: [8, 8],
        cols: [
          { key: getNewKey(), type: 'col', rowSpan: 1, span: 1, style: { height: '35px' }, comp: titleComp },
          { key: getNewKey(), type: 'col', rowSpan: 1, span: 1, style: { height: '35px' }, comp: regUserNameComp },
          { key: getNewKey(), type: 'col', rowSpan: 1, span: 1, style: { height: '35px' }, comp: regDttmComp },
        ],
      },
    ],
  });
