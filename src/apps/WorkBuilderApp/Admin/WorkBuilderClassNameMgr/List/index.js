...
class List extends Component {
  ...
  onOptSave = () => {
    ...
    submitHandlerBySaga(sagaKey, 'POST', '/api/builder/v1/work/classmanage', param, this.onSaveComplete);
  };

  onOptUpdate = () => {
    const { sagaKey, submitHandlerBySaga, formData } = this.props;
    const param = { PARAM: formData };
    submitHandlerBySaga(sagaKey, 'PUT', '/api/builder/v1/work/classmanage', param, this.onSaveComplete);
  };
    ...
    return (
      <div>
        ...
        <BzmModal
          ...
          destroyOnClose
        >
          <ClassNameInput actionType={this.state.actionType} {...this.props} />
        </BzmModal>
      </div>
    );
  }
  ...
  apiArys: [
    {
      ...
      url: '/api/builder/v1/work/classmanage',
      type: 'GET',
      params: {},
    },
  ],
