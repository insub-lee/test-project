...
const makeIfDetailBoardData = () => createSelector(
  selectIfBoardData,
  iFBoardState => iFBoardState.get('getDetailBoardData'),
);

const makeCatePageList = () => createSelector(
  selectIfBoardData,
  iFBoardState => iFBoardState.get('catePageList').toJS(),
);
