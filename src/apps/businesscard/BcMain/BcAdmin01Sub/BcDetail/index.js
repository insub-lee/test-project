...
//  class BcinfoList extends PureComponent {
  ...
  onClickToList = () => {
    ...
    this.props.history.push({
      pathname: `/${basicPath.APPS}/businesscard/BcMain/BcAdmin01Sub`, state: data,
    });
  }
      ...
      <div> <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
       ...
       <div className="buttonWrapper">
            <React.Fragment>
              ...
              <div style={{ float: 'right' }}><LinkBtnLgtGray onClick={this.Cd125_Confirm}>{' 보류처리 '}</LinkBtnLgtGray></div>
              <div style={{ float: 'right' }}><LinkBtnLgtGray 
                            onClick={() =>
                                          this.props.history.push({ pathname: `/${basicPath.APPS}/businesscard/BcMain/BcAdmin01Sub/BcinfoEdt`, search: 'U', state: bInfo })}>
