...
onRowsDeselected = (rows) => {
 ...
 //---------------------------------------------------------------------------------------------------------------
  ...
  dtlLink = (data) => {
    this.props.history.push({ pathname: `/${basicPath.APPS}/businesscard/BcMain/BcAdmin01Sub/BcDetail`, state: data });
  }
 //-------------------------------------------REQST_KOR_NM--------------------------------------------------------------------
...
//------------------------------------------------------------------------
  ...
  render() {
   ...
   <div className="buttonWrapper" align='center'>
            <React.Fragment>
                <LinkBtnLgtGray onClick={this.Cd100_Confirm}>{' 승인 '}</LinkBtnLgtGray>
                <LinkBtnLgtGray onClick={this.Cd126_Confirm}>{' 취소 '}</LinkBtnLgtGray>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
const mapDispatchToProps = dispatch => (
  {
    ...
    delRow126: CardStdCd_Id => dispatch(actions.delRow126(CardStdCd_Id)),
    delRow125: CardStdCd_Id => dispatch(actions.delRow125(CardStdCd_Id)),
  }
);
...
const withReducer = injectReducer({ key: 'SiteList01', reducer });
const withSaga = injectSaga({ key: 'SiteList01', saga });
