...
//  class BcinfoList extends PureComponent {
  ...
  onClickToList = () => {
    ...
    this.props.history.push({
      pathname: '//BcMain/BcAdmin06Sub', state: data,
    });
  }
       ...
       <div className="buttonWrapper">
            <React.Fragment>
              ...
              <div style={{ float: 'right' }}><LinkBtnLgtGray 
                            onClick={() =>
                                          this.props.history.push({ pathname: `/${basicPath.APPS}/businesscard/BcMain/BcAdmin06Sub/BcinfoEdt`, search: 'U', state: bInfo })}>
