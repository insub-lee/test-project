...
onRowsDeselected = (rows) => {
 ...
 //---------------------------------------------------------------------------------------------------------------
  ...
  dtlLink = (data) => {
    this.props.history.push({ pathname: `/${basicPath.APPS}/businesscard/BcMain/BcaskorgSub/BcDetail`, state: data });
  }
 //-------------------------------------------REQST_KOR_NM--------------------------------------------------------------------
...
//-----보류처리 125-------------------------------------------------------------
Cd125_Confirm = () => {
  feed.showConfirm(`발급보류처리 하시겠습니까?`, '', this.Cd125_Row);
}
Cd125_Row = () => {
    ...
    return (
      <div><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
         ...
         <h3 className="pageTitle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{this.state.title}
           ...
           <table align='center'>
                   <tr>
                        <td> <font color='red'>신청자원본 전체현황</font>
                                <table>
                                      <tr>
...
{/*
   <div className="buttonWrapper" align='center'>
            <React.Fragment>
                <LinkBtnLgtGray onClick={this.Cd125_Confirm}>{' 발급보류처리 '}</LinkBtnLgtGray>
            </React.Fragment>
   </div>
*/}
   <StyleSiteAdminList>      
...
const withReducer = injectReducer({ key: 'SiteList07', reducer });
const withSaga = injectSaga({ key: 'SiteList07', saga });
